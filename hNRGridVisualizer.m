classdef hNRGridVisualizer < handle
    %hNRGridVisualizer Scheduler log visualization
    %   The class implements visualization of logs by querying from the
    %   logger (hNRSchedulingLogger object).
    ...
    %
    %   hNRGridVisualizer Name-Value pairs:
    %
    ...
    methods
        function obj = hNRGridVisualizer(simParameters,  varargin)
            %hNRGridVisualizer Construct scheduling log visualization object
            %
